...
Leading is house-standard across every preset: 14.173pt is 5.000mm exactly, so
the baseline grid lands on whole millimetres and a spread's baselines back up
against each other. Presets used to carry eight different values (13 to 18pt);
they were not derived from anything, and a book set on a non-millimetre baseline
...
REFERENCE = {
    ...
    "grid": {"type": "double", "baselineIncrement": DEFAULT_LEADING_PT},
